 ...
 * @author rafael
 */
public class ControlaPedidoEstoqueTest {
    
    private PedidoEstoque caso[] = new PedidoEstoque[5];
    ControlaPedidoEstoque t = new ControlaPedidoEstoque();
    
    public ControlaPedidoEstoqueTest() {
    }
    ...
    public void setUp() {
        ...
        caso[0] = t.getPedidoEstoque("teste0");
        ...
        atendidas. Lista de itens atendidos:
            ...
            A: 0/2 */
        caso[1] = t.getPedidoEstoque("teste1");
        ...
        parcialmente atendidas. Lista de itens atendidos:
            ...
            A: 2/3 */
        caso[2] = t.getPedidoEstoque("teste2");
        ...
        caso[3] = t.getPedidoEstoque("teste3");
        ...
        caso[4] = t.getPedidoEstoque("teste4");
    }
